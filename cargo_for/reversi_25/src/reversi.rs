...
impl OthelloBoard {
    ...
    fn eval_board_for_last(&self, color:usize, count:usize) -> isize{
        ...
        if color == 0{
            ...
            katati = count_pieces(katati_check_white.add2(myboard,color).add2(myboard, color).white);
            oppkatati = count_pieces(katati_check_black.add2(oppboard,oppcolor).add2(oppboard, oppcolor).black);
            ...
            my_kakutei2 = count_pieces(my_kakutei_board2);
            opp_kakutei2 = count_pieces(opp_kakutei_board2);
            katati = count_pieces(katati_check_black.add2(myboard,color).add2(myboard, color).black);
            oppkatati = count_pieces(katati_check_white.add2(oppboard,oppcolor).add2(oppboard, oppcolor).white);
        ...
        if my_kakutei2 > 32{
            ...
            eval_point = eval_point + kakuteisa*30;
        }


        eval_point = eval_point + 3*(katati - oppkatati);
        eval_point = eval_point + 10*(my_kakutei - opp_kakutei);
        eval_point = eval_point - 16*(count_pieces(myboard & !((my_kakutei_board) | (my_kakutei_board2))));
        eval_point = eval_point + 16*(count_pieces(oppboard & !((opp_kakutei_board) | (opp_kakutei_board2))));


        let myv = count_pieces(myvalid);
        let oppv = count_pieces(oppvalid);

        eval_point = eval_point + myv*15 - oppv*15;
